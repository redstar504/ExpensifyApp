                ...
                >
                    ...
                    <RNPickerSelect
                        ...
                        pickerProps={{
                            ...
                            // The following 2 props are specific to web (onChange overrides onValueChange on web)
                            // They are used to make the picker indicator behave the same way on web and native
                            onMouseDown: () => {
